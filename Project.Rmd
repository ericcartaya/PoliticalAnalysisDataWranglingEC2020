...
First I will go over the data and results, then I will cover the 
...
ggplot(data = partyPresidentTable, aes(x = date, y = candidatevotes, fill = party)) + geom_line(aes(x = date, y = candidatevotes, fill = party)) + scale_y_continuous(name="Votes", limits=c(100000, 70000000)) + labs(title ="Votes Each Election", x = "Year", y = "Votes")# A much nicer table will be featured later that has lables and properly displays the 3rd party results.
```
